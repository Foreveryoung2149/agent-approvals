...
export default function PricingPage() {
  return (
    <main className="marketing-shell">
      ...
      <section className="pricing-section"><div className="container pricing-grid" style={{ maxWidth: "520px", margin: "0 auto" }}>
      ...
      <section className="pricing-section" style={{ paddingTop: 0 }}><div className="container" style={{ maxWidth: "520px", margin: "0 auto" }}>
